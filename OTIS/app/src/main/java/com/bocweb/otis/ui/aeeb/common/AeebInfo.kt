...
fun getAeebMoreTopData(): MutableList<AeebInfo> {
    ...
    info1.image2 = Color.parseColor("#568845")
    info1.title = "直线型连廊"
    ...
    info2.image2 = Color.parseColor("#568845")
    info2.title = "直线型连廊2"
    ...
    info3.image2 = Color.parseColor("#568845")
    info3.title = "直线型连廊3"
    ...
    info4.image2 = Color.parseColor("#568845")
    info4.title = "直线型连廊4"
    ...
    info5.image2 = Color.parseColor("#568845")
    info5.title = "直线型连廊5"
